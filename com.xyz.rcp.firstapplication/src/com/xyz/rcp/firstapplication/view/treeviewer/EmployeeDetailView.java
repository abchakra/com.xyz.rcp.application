...
import com.xyz.rcp.firstapplication.validation.StringLongerThenTwo;
...
public class EmployeeDetailView extends ViewPart {
	...
	public void createPartControl(Composite parent) {
		...
		// add tab list
		Control[] controls = new Control[] { firstName, ageText, marriedButton,
				genderCombo, countryText };
	...
	void refresh(Object person) {
		if (person instanceof Person) {
			this.person = (Person) person;
		}
		firstName.setText((this.person).getFirstName());
		ageText.setText((this.person).getAge().toString());
		genderCombo.setText((this.person).getGender());
		countryText.setText((this.person).getAddress().getCountry());
	}
