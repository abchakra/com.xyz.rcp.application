...
<html>
<head>
<title>Feedback form for J2P</title>
</head>
<body>
...
<s:form action="j2pformsubmit" method="POST">
	<table border="0" width=700 cellpadding="0" cellspacing="0">
		<tr>
			<th colspan="5" bgcolor="#7FE897">Feedback form for
			BE/GDM/CC/PM/CMMi</th>
		</tr>
		<tr>
			...
			<s:iterator value="questionList" id="question"
				...
				<tr>
					<td colspan="5"><s:radio list="OptionsSet"
						...
						listValue="label" listKey="optionId" value="%{3}" /></td>
				</tr>
	<!--
				<tr>
					<td colspan="5"><s:radio label="correctOption" name="correctAnswer"
						list="#{'1':'1','2':'2','3':'3','4':'4'}" value="%{4}" /></td>
				</tr>
